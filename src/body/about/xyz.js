            ...
            <div className="row">
                ...
                <div className="col-12 mb-4">
                    <div className="p-4 bg-light rounded shadow-lg">
                        ...
                        <p>
                            We <b>PROSAEC Total Pvt. Ltd.</b> is a distinguished and professionally managed engineering solutions firm headquartered
                        ...
                        <div className="card-container flex-fill mb-3">
                            <div className="card h-100">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Our mission is to be the most reliable engineering partner, delivering
                                        exceptional value through innovative solutions and outstanding service,
                                        while fostering trust and excellence in every project and partnership.
                                    </p>
                                </div>
                            </div>
                        </div>
